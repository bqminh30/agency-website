    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          whileTap={{ scale: 0.92 }}
          className="fixed bottom-6 right-[92px] z-50 w-14 h-14 rounded-full bg-white text-primary shadow-2xl border border-primary/10 flex items-center justify-center hover:bg-bg-light hover:text-accent-blue transition-colors cursor-pointer select-none"
